...
CREATE TABLE des.point_desserte (
 ...
 date_creation timestamptz NOT NULL DEFAULT now(), date_suppression timestamptz
);
...
CREATE TABLE des.liaison_desserte_consommation (
 ...
 periode tstzrange NOT NULL, version integer NOT NULL DEFAULT 1,
...
CREATE TABLE abo.contrat_abonnement (
 ...
 version integer NOT NULL DEFAULT 1, date_creation timestamptz NOT NULL DEFAULT now(), date_suppression timestamptz
);
CREATE TABLE abo.participation_contrat (
 ...
 periode daterange NOT NULL, version integer NOT NULL DEFAULT 1
);
