...
public class ControleurPreview {
 ...
 @OperationPreview("rechercher_points_desserte") @GetMapping("/points-desserte") @PreAuthorize("hasAuthority('SCOPE_points:lecture')") public PagePointsDesserte dessertes(@RequestParam(defaultValue="1")int page,@RequestParam(name="taille_page",defaultValue="20")int taille,@RequestParam(defaultValue="date_creation")String tri,@RequestParam(defaultValue="desc")String direction){var p=desserte.listerDessertes(pagination(page,taille,tri,direction));return new PagePointsDesserte(p.getContent(),page,taille,total(p));}
 ...
 @OperationPreview("rechercher_points_consommation") @GetMapping("/points-consommation") @PreAuthorize("hasAuthority('SCOPE_points:lecture')") public PagePointsConsommation consommations(@RequestParam(defaultValue="1")int page,@RequestParam(name="taille_page",defaultValue="20")int taille,@RequestParam(defaultValue="date_creation")String tri,@RequestParam(defaultValue="desc")String direction){var p=desserte.listerPoints(pagination(page,taille,tri,direction));return new PagePointsConsommation(p.getContent(),page,taille,total(p));}
 ...
 @OperationPreview("rechercher_contrats_abonnement") @GetMapping("/contrats-abonnement") @PreAuthorize("hasAuthority('SCOPE_contrats:lecture')") public PageContrats contrats(@RequestParam(defaultValue="1")int page,@RequestParam(name="taille_page",defaultValue="20")int taille,@RequestParam(defaultValue="date_creation")String tri,@RequestParam(defaultValue="desc")String direction){var p=abonnements.lister(pagination(page,taille,tri,direction));return new PageContrats(p.getContent(),page,taille,total(p));}
 ...
 @OperationPreview("rechercher_compteurs") @GetMapping("/compteurs") @PreAuthorize("hasAuthority('SCOPE_comptage:lecture')") public PageCompteurs compteurs(@RequestParam(defaultValue="1")int page,@RequestParam(name="taille_page",defaultValue="20")int taille,@RequestParam(defaultValue="date_creation")String tri,@RequestParam(defaultValue="desc")String direction){var p=comptage.lister(pagination(page,taille,tri,direction));return new PageCompteurs(p.getContent(),page,taille,total(p));}
 ...
 @OperationPreview("rechercher_affectations_compteur") @GetMapping("/affectations-compteur") @PreAuthorize("hasAuthority('SCOPE_comptage:lecture')") public PageAffectations affectations(@RequestParam(defaultValue="1")int page,@RequestParam(name="taille_page",defaultValue="20")int taille,@RequestParam(defaultValue="date_creation")String tri,@RequestParam(defaultValue="desc")String direction){var p=comptage.listerAffectations(pagination(page,taille,tri,direction));return new PageAffectations(p.getContent(),page,taille,total(p));}
 ...
 private static Pageable pagination(int page,int taille,String tri,String direction){if(page<1)throw new IllegalArgumentException("La page doit être supérieure ou égale à 1.");if(taille<1||taille>100)throw new IllegalArgumentException("La taille de page doit être comprise entre 1 et 100.");Sort.Direction sens;try{sens=Sort.Direction.fromString(direction);}catch(IllegalArgumentException e){throw new IllegalArgumentException("La direction de tri doit être asc ou desc.");}return PageRequest.of(page-1,taille,Sort.by(sens,tri));}
 private static long total(Page<?> page){return page.getTotalElements();}
}
