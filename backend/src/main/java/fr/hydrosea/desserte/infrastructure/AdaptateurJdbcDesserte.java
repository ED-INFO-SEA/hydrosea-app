...
public class AdaptateurJdbcDesserte implements PortDesserte {
  ...
  public Page<VuePointDesserte> listerDessertes(Pageable page){return PaginationJdbc.executer(jdbc,"SELECT count(*) FROM des.point_desserte WHERE date_suppression IS NULL","SELECT id,reference,statut,identifiant_commune,identifiant_adresse,version FROM des.point_desserte WHERE date_suppression IS NULL",page,Map.of("date_creation","date_creation","reference","reference","statut","statut"),DESSERTE);}
  ...
  public Page<VuePointConsommation> listerPoints(Pageable page){return PaginationJdbc.executer(jdbc,"SELECT count(*) FROM des.point_consommation WHERE date_suppression IS NULL","SELECT id,reference,statut,usage,identifiant_adresse,version FROM des.point_consommation WHERE date_suppression IS NULL",page,Map.of("date_creation","date_creation","reference","reference","statut","statut"),POINT);}
